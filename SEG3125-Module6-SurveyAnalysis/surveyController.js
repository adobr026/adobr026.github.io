...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var optRadio = readData("optRadio");
        var colors = readData("colors");
        var brand = readData("brand");
        var navigate = readData("navigate");
        var txtArea = readData("txtArea");
        res.render('showResults', {results: [impression, optRadio, colors, brand, navigate, txtArea]});
